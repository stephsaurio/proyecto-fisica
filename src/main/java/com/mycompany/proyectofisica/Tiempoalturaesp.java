 ...
 * @author gomez
 */
public class Tiempoalturaesp extends javax.swing.JFrame {

    /**
     * Creates new form Tiempoalturaesp
     */
    public Tiempoalturaesp() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Calcular tiempo en altura especifica");
        ...
        getContentPane().add(Respuesta, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 120, 560, 40));
        ...
        getContentPane().add(VelocidadInicialField, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 180, 260, 30));
        ...
        getContentPane().add(unidadVelocidadInicial, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 180, 110, 30));
        ...
        getContentPane().add(distanciaLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 230, -1, -1));
        ...
        getContentPane().add(anguloField, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 230, 260, 30));
        ...
        getContentPane().add(unidadAngulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 230, 90, 30));
        ...
        getContentPane().add(unidadSalida1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 80, 80, 30));
        ...
        getContentPane().add(alturaInicialField, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 80, 260, 30));
        ...
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, -1, 40));
        ...
        getContentPane().add(TiempoLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, -1, -1));
        ...
        getContentPane().add(alturayField, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 280, 260, 30));
        ...
        getContentPane().add(unidadY, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 280, 110, 30));
        ...
        getContentPane().add(AceleracionLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, -1, -1));
        ...
        getContentPane().add(V0yField, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 130, 290, 30));
        ...
        getContentPane().add(unidadV0y, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 130, 100, 30));
...
// Altura inicial
            ...
            // Calcular V0y si no se ingresó directamentetxtAlturaEspecifica
            if (V0y == 0 && V0 != 0 && angulo != 0) {
                V0y = V0 * Math.sin(anguloRad);
            }
            if (V0 == 0 && V0y == 0) {
                Respuesta.setText("No hay movimiento vertical.");
                formula.setText("");
                return;
            }
            // Resolver ecuación cuadrática: 0 = y₀ + V₀y·t - ½·g·t² - h(t)
            double a = -0.5 * g;
            double b = V0y;
            double c = y0 - h;
            ...
            if (discriminante < 0) {
                Respuesta.setText("No hay solución real.");
                formula.setText("Discriminante negativo");
                return;
            }
            ...
            String resultado;
            if (t1 >= 0 && t2 >= 0) {
                resultado = String.format("El objeto pasa por %.0f%s en %.2f%s y %.2f%s",
                        h,
                        unidadY.getSelectedItem(),
                        t1,
                        unidadSalida.getSelectedItem(),
                        t2,
                        unidadSalida.getSelectedItem()
                );
            } else if (t1 >= 0) {
                resultado = String.format("%.2f s", t1);
            } else if (t2 >= 0) {
                resultado = String.format("%.2f s", t2);
            } else {
                resultado = "No hay tiempos positivos.";
            }

            Respuesta.setText(resultado);
            formula.setText("Fórmula: h(t) = y₀ + V₀y·t - ½·g·t²");
