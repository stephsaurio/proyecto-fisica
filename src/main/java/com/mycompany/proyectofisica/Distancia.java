...
public class Distancia extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(unidadSalida, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 90, 170, 40));
        ...
        jLabel4.setText("Calcular distancia");
        ...
        getContentPane().add(distanciaField, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 90, 256, -1));
        ...
        getContentPane().add(unidadDistancia, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 250, 87, 37));
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 410, 240, 40));
    ...
    private void MasaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MasaActionPerformed
        ...
        if (unidadSalida.getSelectedItem().equals("m/s")) {
            velocidad = Double.parseDouble(distanciaField.getText()) * (3600.0 / 1000.0); // Convertir m/s a km/h
        } else {
            velocidad = Double.parseDouble(distanciaField.getText());
        }
        ...
        if (tiempo > 0) {
            ...
            // Determinar la unidad de salida y mostrar el resultado
            if (unidadDistancia.getSelectedItem().equals("m")) {
                distancia *= 1000; // Convertir kilómetros a metros
            }
            jLabel9.setText(String.format("%.2f %s", distancia, unidadDistancia.getSelectedItem()));
        } else {
